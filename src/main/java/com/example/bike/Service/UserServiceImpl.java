...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public boolean senMsg(String countryCode, String phoneNum) {
        //调运短信的API；
        //向对应手机号发送短信验证码
        //
...
//            //将发送手机号作为key，验证码作为value保存在redis
            stringRedisTemplate.opsForValue().set(phoneNum, code, 6000, TimeUnit.SECONDS);
